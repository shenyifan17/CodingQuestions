...
# We can sort all the intervals by start time and 
# then check if any two intervals overlap. 
# A person will not be able to attend all appointments 
# if any two appointments overlap.

def can_attend_all_appointments(intervals):

    ## similiar to merge intervals pattern:
...
# our algorithm will take O(N∗logN) since we need to sort them in the beginning.
# 
# Space complexity
