...
# Output: 1
# Explanation: 
# The biggest number smaller than or equal to '6' is '6' having index '1'.
# Example 2:
# 
# Input: [1, 3, 8, 10, 15], key = 12
# Output: 3
# Explanation: 
# The biggest number smaller than or equal to '12' is '10' having index '3'.
# Example 3:
# 
# Input: [4, 6, 10], key = 17
# Output: 2
# Explanation: 
# The biggest number smaller than or equal to '17' is '10' having index '2'.
# Example 4:
# 
# Input: [4, 6, 10], key = -1
# Output: -1
# Explanation: 
# There is no number smaller than or equal to '-1' in the given array.
...
def search_floor_of_a_number(arr, key):
    ...
    # so tt the end of the wile loop, "start == end + 1"
