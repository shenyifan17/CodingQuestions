...
# Output: 'h'
# Explanation: 
# The smallest letter greater than 'f' is 'h' in the given array.
# 
# Example 2:
# 
# Input: ['a', 'c', 'f', 'h'], key = 'b'
# Output: 'c'
# Explanation: 
# The smallest letter greater than 'b' is 'c'.
# 
# Example 3:
# 
# Input: ['a', 'c', 'f', 'h'], key = 'm'
# Output: 'a'
# Explanation: 
# As the array is assumed to be circular, the smallest letter greater than 'm' is 'a'.
# 
# Example 4:
# 
# Input: ['a', 'c', 'f', 'h'], key = 'h'
# Output: 'a'
# Explanation: 
# As the array is assumed to be circular, the smallest letter greater than 'h' is 'a'.
...
# Time complexity
# Since, 
# we are reducing the search range by half at every step,
