...
# create a new array containing squares of 
...
# at both the ends of the input array. 
# At any step, whichever pointer gives us the bigger square 
# we add it to the result array and move to the next/previous number 
# according to the pointer. 

def make_squares(arr):
    """"
    Time comp O(N), space comp O(N) for output array 
    """
