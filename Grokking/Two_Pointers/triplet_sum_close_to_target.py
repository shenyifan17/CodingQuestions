...
## A Two Pointers pattern, similar to Triplet Sum to Zero 
...
def triplet_sum_close_to_target(arr, target_sum):
    ...
    for i in range(len(arr) - 2):
        ...
        while (left < right):
            ...
            if target_diff == 0: # we 've found the triplet with exact sum 
                print('we have found the triplet with exact sum')
...
def main():
    ...
    print(triplet_sum_close_to_target([1, 0, 1, 8], 9))
